...
public interface IUserRepository extends MongoRepository<AppUsers, String> {
    ...
    List<AppUsers> findByEmailContainingIgnoreCaseOrUsernameContainingIgnoreCase(String email, String username);
    List<AppUsers> findByEmailContainingIgnoreCaseOrUsernameContainingIgnoreCaseAndIdNot(
            String email, String username, String currentUserId);
}
